...
public class AlbumTest {
	...
	public static void setUpBeforeClass() throws Exception {
        ...
        String testResourceDir = System.getProperty("user.home") + "/src/magnatune_downer/resources/test/";	
		url = new URL("http://localhost:10808/artists/albums/carlosschwarz-seatosky/hifi.m3u");
        dir = new File(testResourceDir);
			
		wwwFiles = new HashMap<String, Long>(5);
		for (File file : new File(testResourceDir, "www/all/").listFiles()) {
	...
	@Test
	public void testGetSongs() throws M3uException {
